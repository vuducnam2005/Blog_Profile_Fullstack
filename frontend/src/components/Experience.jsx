...
export default function Experience() {
  ...
  return (
    <section id="experience" className="min-h-screen pt-20 md:pt-24 pb-12 md:pb-16 px-3 md:px-12 lg:px-24">
      <h2 className="text-3xl md:text-5xl font-extrabold text-[#F1D89E] mb-10 md:mb-16 flex items-center">
        <span className="bg-[#F1D89E] w-8 md:w-12 h-1 mr-3 md:mr-4"></span> {t('exp.title', 'Kinh nghiệm & Học vấn')}
      </h2>
      
      <div className="mb-10 md:mb-16">
        <h3 className="text-xl md:text-2xl font-bold text-[#F1D89E] mb-6 md:mb-8 flex items-center gap-2 md:gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
            {experiences.map((exp, idx) => {
                ...
                return (
                    <div key={idx} className={`border-l-2 border-[#F1D89E]/30 pl-4 md:pl-6 ml-3 md:ml-4 relative p-4 md:p-6 rounded-xl md:rounded-2xl transition-all duration-300 border ${colorClass}`}>
      ...
      <h3 className="text-xl md:text-2xl font-bold text-[#F1D89E] mb-4 md:mb-6 flex items-center gap-2 md:gap-3 mt-6 md:mt-8">
        <Medal className="w-6 h-6 md:w-8 md:h-8" /> {t('exp.awards', 'Chứng chỉ & Giải thưởng')}
      </h3>
      
      <div className="flex flex-col gap-3 md:gap-4">
        <div className="bg-gradient-to-r from-emerald-900/50 to-teal-900/30 border border-emerald-500/25 rounded-xl md:rounded-2xl p-4 md:p-6 flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center hover:border-emerald-400/50 hover:shadow-[0_0_25px_rgba(16,185,129,0.15)] transition-all duration-300">
        ...
        <div className="bg-gradient-to-r from-violet-900/50 to-blue-900/30 border border-violet-500/25 rounded-xl md:rounded-2xl p-4 md:p-6 flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center hover:border-violet-400/50 hover:shadow-[0_0_25px_rgba(139,92,246,0.15)] transition-all duration-300">
        ...
        <div className="bg-gradient-to-r from-rose-900/50 to-pink-900/30 border border-rose-500/25 rounded-xl md:rounded-2xl p-4 md:p-6 flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center hover:border-rose-400/50 hover:shadow-[0_0_25px_rgba(244,63,94,0.15)] transition-all duration-300">
